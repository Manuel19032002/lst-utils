...
#SBATCH --job-name=LST1_21023
#SBATCH --time=2:00:00
#SBATCH --chdir=/fefs/onsite/data/lst-pipe/LSTN-01/running_analysis/20250702/v0.11
#SBATCH --output=log/Run21023.%4a_jobid_%A.out
#SBATCH --error=log/Run21023.%4a_jobid_%A.err
#SBATCH --array=0-86
...
with tempfile.TemporaryDirectory() as tmpdirname:
    ...
    proc = subprocess.run([
        ...
        '--dl1b-config=/fefs/aswg/data/real/auxiliary/TailCuts/dl1ab_Run21023.json',
